...
def get_games(list):
    ...
    n = 1
    while n <= pages:
        print('Entering games from page n. %d .' % n)
...
def entry_gift(code):
    ...
    if json_data['type'] == 'success':
        print('> We entered ' + game_name + ' giveaway')
...
def loop():
    ...
    get_games("wishlist")
    if int(points) > 80:
        print('Wishlist complete. Some points left so going through all games... ')
        get_games("all")
    print('List complete.')
